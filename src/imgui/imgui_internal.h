...
//#endif
    ...
    IMGUI_API bool          TreeNodeWithImageBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end = NULL, void* textureID = nullptr, bool isDirectory = false, bool static_highlight = false);
